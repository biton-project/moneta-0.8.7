...
uint256 hashGenesisBlock("0xf524460928326bffb73b52b8c4e1e30a35b0128609e11c582ca266adb4b1c40a");
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Moneta: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Moneta: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x642e8a7b6549d54a5f13d78ecfa8f024740fbc145f0ed0fd211d65e02afff70c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1434971660;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4016724;
        ...
        assert(block.hashMerkleRoot == uint256("0x8712c2b33c8015244188ac1bf0dce7c40ef17e3cf79c48d6e31e2b8ae6412c4f"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Moneta: increase each by adding 2 to bitcoin's value.
